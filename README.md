...
```python
class YadCarias:
    rol      = "Fundador & CEO — Obsidian-Sec"
    enfoque  = ["Seguridad ofensiva", "Red Team", "Desarrollo de producto"]
    mision   = "Pensar como el atacante para fortalecer al defensor"
...
<!-- ░░░ ANIMACIÓN SERPIENTE — se activa al ejecutar el workflow snake.yml ░░░ -->
<picture>
